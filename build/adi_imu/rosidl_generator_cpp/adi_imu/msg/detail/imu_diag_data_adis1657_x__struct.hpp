...
#ifndef ADI_IMU__MSG__DETAIL__IMU_DIAG_DATA_ADIS1657_X__STRUCT_HPP_
#define ADI_IMU__MSG__DETAIL__IMU_DIAG_DATA_ADIS1657_X__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__adi_imu__msg__ImuDiagDataADIS1657X __attribute__((deprecated))
#else
# define DEPRECATED__adi_imu__msg__ImuDiagDataADIS1657X __declspec(deprecated)
#endif
...
struct ImuDiagDataADIS1657X_
{
  using Type = ImuDiagDataADIS1657X_<ContainerAllocator>;

  explicit ImuDiagDataADIS1657X_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      this->diag_sensor_initialization_failure = false;
      ...
      this->diag_aduc_mcu_fault = false;
      this->diag_flash_memory_write_count_exceeded_error = false;
      this->flash_counter = 0ul;
    }
  }

  explicit ImuDiagDataADIS1657X_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  _header_type header;
  using _diag_sensor_initialization_failure_type =
    bool;
  _diag_sensor_initialization_failure_type diag_sensor_initialization_failure;
  ...
  using _diag_aduc_mcu_fault_type =
    bool;
  _diag_aduc_mcu_fault_type diag_aduc_mcu_fault;
  ...
  Type & set__diag_sensor_initialization_failure(
    const bool & _arg)
  {
    this->diag_sensor_initialization_failure = _arg;
    return *this;
  }
  ...
  Type & set__diag_aduc_mcu_fault(
    const bool & _arg)
  {
    this->diag_aduc_mcu_fault = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator> *;
  using ConstRawPtr =
    const adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__adi_imu__msg__ImuDiagDataADIS1657X
    std::shared_ptr<adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__adi_imu__msg__ImuDiagDataADIS1657X
    std::shared_ptr<adi_imu::msg::ImuDiagDataADIS1657X_<ContainerAllocator> const>
  ...
  bool operator==(const ImuDiagDataADIS1657X_ & other) const
  {
    if (this->header != other.header) {
      return false;
    }
    if (this->diag_sensor_initialization_failure != other.diag_sensor_initialization_failure) {
      return false;
    }
    ...
    if (this->diag_aduc_mcu_fault != other.diag_aduc_mcu_fault) {
      return false;
    }
...
using ImuDiagDataADIS1657X =
  adi_imu::msg::ImuDiagDataADIS1657X_<std::allocator<void>>;
...
#endif  // ADI_IMU__MSG__DETAIL__IMU_DIAG_DATA_ADIS1657_X__STRUCT_HPP_
