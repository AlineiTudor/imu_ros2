...
#ifndef ADI_IMU__MSG__DETAIL__IMU_FULL_MEASURED_DATA__STRUCT_HPP_
#define ADI_IMU__MSG__DETAIL__IMU_FULL_MEASURED_DATA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__adi_imu__msg__ImuFullMeasuredData __attribute__((deprecated))
#else
# define DEPRECATED__adi_imu__msg__ImuFullMeasuredData __declspec(deprecated)
#endif
...
struct ImuFullMeasuredData_
{
  ...
  // pointer types
  using RawPtr =
    adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator> *;
  using ConstRawPtr =
    const adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__adi_imu__msg__ImuFullMeasuredData
    std::shared_ptr<adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__adi_imu__msg__ImuFullMeasuredData
    std::shared_ptr<adi_imu::msg::ImuFullMeasuredData_<ContainerAllocator> const>
...
using ImuFullMeasuredData =
  adi_imu::msg::ImuFullMeasuredData_<std::allocator<void>>;
...
#endif  // ADI_IMU__MSG__DETAIL__IMU_FULL_MEASURED_DATA__STRUCT_HPP_
