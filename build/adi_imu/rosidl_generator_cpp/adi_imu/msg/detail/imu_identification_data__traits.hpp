...
#ifndef ADI_IMU__MSG__DETAIL__IMU_IDENTIFICATION_DATA__TRAITS_HPP_
#define ADI_IMU__MSG__DETAIL__IMU_IDENTIFICATION_DATA__TRAITS_HPP_
...
inline void to_yaml(
  const adi_imu::msg::ImuIdentificationData & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const adi_imu::msg::ImuIdentificationData & msg)
{
  return adi_imu::msg::to_yaml(msg);
}

template<>
inline const char * data_type<adi_imu::msg::ImuIdentificationData>()
{
  return "adi_imu::msg::ImuIdentificationData";
}

template<>
inline const char * name<adi_imu::msg::ImuIdentificationData>()
{
  return "adi_imu/msg/ImuIdentificationData";
}

template<>
struct has_fixed_size<adi_imu::msg::ImuIdentificationData>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<adi_imu::msg::ImuIdentificationData>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<adi_imu::msg::ImuIdentificationData>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ADI_IMU__MSG__DETAIL__IMU_IDENTIFICATION_DATA__TRAITS_HPP_
