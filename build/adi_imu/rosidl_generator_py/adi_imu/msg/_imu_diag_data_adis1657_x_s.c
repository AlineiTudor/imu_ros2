...
bool adi_imu__msg__imu_diag_data_adis1657_x__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("adi_imu.msg._imu_diag_data_adis1657_x.ImuDiagDataADIS1657X", full_classname_dest, 58) == 0);
  }
  adi_imu__msg__ImuDiagDataADIS1657X * ros_message = _ros_message;
  {  // header
  ...
  {  // diag_sensor_initialization_failure
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_sensor_initialization_failure");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->diag_sensor_initialization_failure = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // diag_x_axis_gyroscope_failure
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_x_axis_gyroscope_failure");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->diag_x_axis_gyroscope_failure = (Py_True == field);
    Py_DECREF(field);
  }
  {  // diag_y_axis_gyroscope_failure
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_y_axis_gyroscope_failure");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->diag_y_axis_gyroscope_failure = (Py_True == field);
    Py_DECREF(field);
  }
  {  // diag_z_axis_gyroscope_failure
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_z_axis_gyroscope_failure");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->diag_z_axis_gyroscope_failure = (Py_True == field);
    Py_DECREF(field);
  }
  {  // diag_x_axis_accelerometer_failure
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_x_axis_accelerometer_failure");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->diag_x_axis_accelerometer_failure = (Py_True == field);
    Py_DECREF(field);
  }
  {  // diag_y_axis_accelerometer_failure
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_y_axis_accelerometer_failure");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->diag_y_axis_accelerometer_failure = (Py_True == field);
    Py_DECREF(field);
  }
  {  // diag_z_axis_accelerometer_failure
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_z_axis_accelerometer_failure");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->diag_z_axis_accelerometer_failure = (Py_True == field);
    Py_DECREF(field);
  }
  {  // diag_aduc_mcu_fault
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_aduc_mcu_fault");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->diag_aduc_mcu_fault = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ImuDiagDataADIS1657X */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("adi_imu.msg._imu_diag_data_adis1657_x");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImuDiagDataADIS1657X");
  ...
  {  // diag_sensor_initialization_failure
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->diag_sensor_initialization_failure ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "diag_sensor_initialization_failure", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // diag_x_axis_gyroscope_failure
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->diag_x_axis_gyroscope_failure ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "diag_x_axis_gyroscope_failure", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // diag_y_axis_gyroscope_failure
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->diag_y_axis_gyroscope_failure ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "diag_y_axis_gyroscope_failure", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // diag_z_axis_gyroscope_failure
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->diag_z_axis_gyroscope_failure ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "diag_z_axis_gyroscope_failure", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // diag_x_axis_accelerometer_failure
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->diag_x_axis_accelerometer_failure ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "diag_x_axis_accelerometer_failure", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // diag_y_axis_accelerometer_failure
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->diag_y_axis_accelerometer_failure ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "diag_y_axis_accelerometer_failure", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // diag_z_axis_accelerometer_failure
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->diag_z_axis_accelerometer_failure ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "diag_z_axis_accelerometer_failure", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // diag_aduc_mcu_fault
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->diag_aduc_mcu_fault ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "diag_aduc_mcu_fault", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
