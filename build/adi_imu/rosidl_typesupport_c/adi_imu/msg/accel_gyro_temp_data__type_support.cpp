...
static const _AccelGyroTempData_type_support_symbol_names_t _AccelGyroTempData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, adi_imu, msg, AccelGyroTempData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, adi_imu, msg, AccelGyroTempData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, adi_imu, msg, AccelGyroTempData)() {
  return &::adi_imu::msg::rosidl_typesupport_c::AccelGyroTempData_message_type_support_handle;
}
