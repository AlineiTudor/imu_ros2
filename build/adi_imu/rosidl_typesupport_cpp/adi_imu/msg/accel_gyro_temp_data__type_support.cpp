...
static const _AccelGyroTempData_type_support_symbol_names_t _AccelGyroTempData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, adi_imu, msg, AccelGyroTempData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, adi_imu, msg, AccelGyroTempData)),
  }
};
...
{
  return &::adi_imu::msg::rosidl_typesupport_cpp::AccelGyroTempData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, adi_imu, msg, AccelGyroTempData)() {
  return get_message_type_support_handle<adi_imu::msg::AccelGyroTempData>();
}
