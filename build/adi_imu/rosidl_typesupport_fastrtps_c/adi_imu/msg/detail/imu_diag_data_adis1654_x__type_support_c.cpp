...
#include "adi_imu/msg/detail/imu_diag_data_adis1654_x__rosidl_typesupport_fastrtps_c.h"
...
using _ImuDiagDataADIS1654X__ros_msg_type = adi_imu__msg__ImuDiagDataADIS1654X;

static bool _ImuDiagDataADIS1654X__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ImuDiagDataADIS1654X__ros_msg_type * ros_message = static_cast<const _ImuDiagDataADIS1654X__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _ImuDiagDataADIS1654X__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ImuDiagDataADIS1654X__ros_msg_type * ros_message = static_cast<_ImuDiagDataADIS1654X__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_adi_imu__msg__ImuDiagDataADIS1654X(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ImuDiagDataADIS1654X__ros_msg_type * ros_message = static_cast<const _ImuDiagDataADIS1654X__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ImuDiagDataADIS1654X__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_adi_imu__msg__ImuDiagDataADIS1654X(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_adi_imu
size_t max_serialized_size_adi_imu__msg__ImuDiagDataADIS1654X(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = adi_imu__msg__ImuDiagDataADIS1654X;
    is_plain =
      (
...
static size_t _ImuDiagDataADIS1654X__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_adi_imu__msg__ImuDiagDataADIS1654X(
...
static message_type_support_callbacks_t __callbacks_ImuDiagDataADIS1654X = {
  "adi_imu::msg",
  "ImuDiagDataADIS1654X",
  _ImuDiagDataADIS1654X__cdr_serialize,
  _ImuDiagDataADIS1654X__cdr_deserialize,
  _ImuDiagDataADIS1654X__get_serialized_size,
  _ImuDiagDataADIS1654X__max_serialized_size
};

static rosidl_message_type_support_t _ImuDiagDataADIS1654X__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ImuDiagDataADIS1654X,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, adi_imu, msg, ImuDiagDataADIS1654X)() {
  return &_ImuDiagDataADIS1654X__type_support;
}
