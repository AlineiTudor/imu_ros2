...
#include "adi_imu/msg/detail/imu_diag_data_adis1655_x__rosidl_typesupport_fastrtps_c.h"
...
#include "adi_imu/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_adi_imu
...
using _ImuDiagDataADIS1655X__ros_msg_type = adi_imu__msg__ImuDiagDataADIS1655X;

static bool _ImuDiagDataADIS1655X__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ImuDiagDataADIS1655X__ros_msg_type * ros_message = static_cast<const _ImuDiagDataADIS1655X__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: diag_automatic_reset
  {
    cdr << (ros_message->diag_automatic_reset ? true : false);
  }
  ...
  // Field name: diag_crc_error
  {
    cdr << (ros_message->diag_crc_error ? true : false);
  }

  // Field name: diag_x_axis_gyroscope_failure
  {
    cdr << (ros_message->diag_x_axis_gyroscope_failure ? true : false);
  }

  // Field name: diag_y_axis_gyroscope_failure
  {
    cdr << (ros_message->diag_y_axis_gyroscope_failure ? true : false);
  }

  // Field name: diag_z_axis_gyroscope_failure
  {
    cdr << (ros_message->diag_z_axis_gyroscope_failure ? true : false);
  }

  // Field name: diag_x_axis_accelerometer_failure
  {
    cdr << (ros_message->diag_x_axis_accelerometer_failure ? true : false);
  }

  // Field name: diag_y_axis_accelerometer_failure
  {
    cdr << (ros_message->diag_y_axis_accelerometer_failure ? true : false);
  }

  // Field name: diag_z_axis_accelerometer_failure
  {
...
static bool _ImuDiagDataADIS1655X__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ImuDiagDataADIS1655X__ros_msg_type * ros_message = static_cast<_ImuDiagDataADIS1655X__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: diag_automatic_reset
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->diag_automatic_reset = tmp ? true : false;
  }
  ...
  // Field name: diag_crc_error
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->diag_crc_error = tmp ? true : false;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_adi_imu
size_t get_serialized_size_adi_imu__msg__ImuDiagDataADIS1655X(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ImuDiagDataADIS1655X__ros_msg_type * ros_message = static_cast<const _ImuDiagDataADIS1655X__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name diag_automatic_reset
  {
    size_t item_size = sizeof(ros_message->diag_automatic_reset);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name diag_clock_error
  ...
  // field.name diag_crc_error
  {
    size_t item_size = sizeof(ros_message->diag_crc_error);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name diag_x_axis_gyroscope_failure
...
static uint32_t _ImuDiagDataADIS1655X__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_adi_imu__msg__ImuDiagDataADIS1655X(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_adi_imu
size_t max_serialized_size_adi_imu__msg__ImuDiagDataADIS1655X(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = adi_imu__msg__ImuDiagDataADIS1655X;
    is_plain =
      (
...
static size_t _ImuDiagDataADIS1655X__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_adi_imu__msg__ImuDiagDataADIS1655X(
...
static message_type_support_callbacks_t __callbacks_ImuDiagDataADIS1655X = {
  "adi_imu::msg",
  "ImuDiagDataADIS1655X",
  _ImuDiagDataADIS1655X__cdr_serialize,
  _ImuDiagDataADIS1655X__cdr_deserialize,
  _ImuDiagDataADIS1655X__get_serialized_size,
  _ImuDiagDataADIS1655X__max_serialized_size
};

static rosidl_message_type_support_t _ImuDiagDataADIS1655X__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ImuDiagDataADIS1655X,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, adi_imu, msg, ImuDiagDataADIS1655X)() {
  return &_ImuDiagDataADIS1655X__type_support;
}
