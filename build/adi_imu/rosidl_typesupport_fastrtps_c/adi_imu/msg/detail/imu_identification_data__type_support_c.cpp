...
#include "adi_imu/msg/detail/imu_identification_data__rosidl_typesupport_fastrtps_c.h"
...
using _ImuIdentificationData__ros_msg_type = adi_imu__msg__ImuIdentificationData;
...
size_t get_serialized_size_adi_imu__msg__ImuIdentificationData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ImuIdentificationData__ros_msg_type * ros_message = static_cast<const _ImuIdentificationData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ImuIdentificationData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_adi_imu__msg__ImuIdentificationData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_adi_imu
size_t max_serialized_size_adi_imu__msg__ImuIdentificationData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = adi_imu__msg__ImuIdentificationData;
    is_plain =
      (
...
static size_t _ImuIdentificationData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_adi_imu__msg__ImuIdentificationData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, adi_imu, msg, ImuIdentificationData)() {
