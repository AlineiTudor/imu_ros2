...
#include "adi_imu/msg/detail/imu_diag_data_adis1647_x__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const adi_imu::msg::ImuDiagDataADIS1647X & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  adi_imu::msg::ImuDiagDataADIS1647X & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_adi_imu
max_serialized_size_ImuDiagDataADIS1647X(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = adi_imu::msg::ImuDiagDataADIS1647X;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const adi_imu::msg::ImuDiagDataADIS1647X *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<adi_imu::msg::ImuDiagDataADIS1647X *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ImuDiagDataADIS1647X__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const adi_imu::msg::ImuDiagDataADIS1647X *>(
...
static size_t _ImuDiagDataADIS1647X__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ImuDiagDataADIS1647X(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ImuDiagDataADIS1647X__callbacks = {
  "adi_imu::msg",
...
static rosidl_message_type_support_t _ImuDiagDataADIS1647X__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ImuDiagDataADIS1647X__callbacks,
...
{
  return &adi_imu::msg::typesupport_fastrtps_cpp::_ImuDiagDataADIS1647X__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, adi_imu, msg, ImuDiagDataADIS1647X)() {
  return &adi_imu::msg::typesupport_fastrtps_cpp::_ImuDiagDataADIS1647X__handle;
}
