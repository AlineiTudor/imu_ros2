...
#include "adi_imu/msg/detail/vel_ang_temp_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = adi_imu::msg::VelAngTempData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const adi_imu::msg::VelAngTempData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<adi_imu::msg::VelAngTempData *>(
    untyped_ros_message);
...
{
  return &adi_imu::msg::typesupport_fastrtps_cpp::_VelAngTempData__handle;
}
