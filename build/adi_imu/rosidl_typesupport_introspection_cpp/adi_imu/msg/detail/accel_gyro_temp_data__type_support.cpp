...
{
  new (message_memory) adi_imu::msg::AccelGyroTempData(_init);
}

void AccelGyroTempData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<adi_imu::msg::AccelGyroTempData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AccelGyroTempData_message_member_array[4] = {
  {
    ...
    offsetof(adi_imu::msg::AccelGyroTempData, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(adi_imu::msg::AccelGyroTempData, linear_acceleration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(adi_imu::msg::AccelGyroTempData, angular_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(adi_imu::msg::AccelGyroTempData, temperature),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AccelGyroTempData_message_members = {
  ...
  4,  // number of fields
  sizeof(adi_imu::msg::AccelGyroTempData),
...
get_message_type_support_handle<adi_imu::msg::AccelGyroTempData>()
{
  return &::adi_imu::msg::rosidl_typesupport_introspection_cpp::AccelGyroTempData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, adi_imu, msg, AccelGyroTempData)() {
  return &::adi_imu::msg::rosidl_typesupport_introspection_cpp::AccelGyroTempData_message_type_support_handle;
}
