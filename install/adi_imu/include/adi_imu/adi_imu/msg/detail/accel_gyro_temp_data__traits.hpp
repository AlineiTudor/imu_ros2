...
#ifndef ADI_IMU__MSG__DETAIL__ACCEL_GYRO_TEMP_DATA__TRAITS_HPP_
#define ADI_IMU__MSG__DETAIL__ACCEL_GYRO_TEMP_DATA__TRAITS_HPP_
...
inline void to_yaml(
  const adi_imu::msg::AccelGyroTempData & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const adi_imu::msg::AccelGyroTempData & msg)
{
  return adi_imu::msg::to_yaml(msg);
}

template<>
inline const char * data_type<adi_imu::msg::AccelGyroTempData>()
{
  return "adi_imu::msg::AccelGyroTempData";
}

template<>
inline const char * name<adi_imu::msg::AccelGyroTempData>()
{
  return "adi_imu/msg/AccelGyroTempData";
}

template<>
struct has_fixed_size<adi_imu::msg::AccelGyroTempData>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Vector3>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<adi_imu::msg::AccelGyroTempData>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::Vector3>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<adi_imu::msg::AccelGyroTempData>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ADI_IMU__MSG__DETAIL__ACCEL_GYRO_TEMP_DATA__TRAITS_HPP_
