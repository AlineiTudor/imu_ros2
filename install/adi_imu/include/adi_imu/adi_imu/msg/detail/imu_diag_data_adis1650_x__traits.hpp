...
#ifndef ADI_IMU__MSG__DETAIL__IMU_DIAG_DATA_ADIS1650_X__TRAITS_HPP_
#define ADI_IMU__MSG__DETAIL__IMU_DIAG_DATA_ADIS1650_X__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const ImuDiagDataADIS1650X & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
...
inline std::string to_yaml(const ImuDiagDataADIS1650X & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const adi_imu::msg::ImuDiagDataADIS1650X & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const adi_imu::msg::ImuDiagDataADIS1650X & msg)
{
  return adi_imu::msg::to_yaml(msg);
}

template<>
inline const char * data_type<adi_imu::msg::ImuDiagDataADIS1650X>()
{
  return "adi_imu::msg::ImuDiagDataADIS1650X";
}

template<>
inline const char * name<adi_imu::msg::ImuDiagDataADIS1650X>()
{
  return "adi_imu/msg/ImuDiagDataADIS1650X";
}

template<>
struct has_fixed_size<adi_imu::msg::ImuDiagDataADIS1650X>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<adi_imu::msg::ImuDiagDataADIS1650X>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<adi_imu::msg::ImuDiagDataADIS1650X>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ADI_IMU__MSG__DETAIL__IMU_DIAG_DATA_ADIS1650_X__TRAITS_HPP_
