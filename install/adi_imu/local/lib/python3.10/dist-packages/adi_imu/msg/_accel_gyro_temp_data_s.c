...
bool adi_imu__msg__accel_gyro_temp_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("adi_imu.msg._accel_gyro_temp_data.AccelGyroTempData", full_classname_dest, 51) == 0);
  }
  adi_imu__msg__AccelGyroTempData * ros_message = _ros_message;
  {  // header
...
PyObject * adi_imu__msg__accel_gyro_temp_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("adi_imu.msg._accel_gyro_temp_data");
