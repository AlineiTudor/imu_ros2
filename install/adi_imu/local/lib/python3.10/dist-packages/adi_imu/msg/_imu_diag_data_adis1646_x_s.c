...
bool adi_imu__msg__imu_diag_data_adis1646_x__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("adi_imu.msg._imu_diag_data_adis1646_x.ImuDiagDataADIS1646X", full_classname_dest, 58) == 0);
  }
  adi_imu__msg__ImuDiagDataADIS1646X * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ImuDiagDataADIS1646X */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("adi_imu.msg._imu_diag_data_adis1646_x");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImuDiagDataADIS1646X");
