...
class Metaclass_ImuDiagDataADIS1650X(type):
    """Metaclass of message 'ImuDiagDataADIS1650X'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'adi_imu.msg.ImuDiagDataADIS1650X')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__imu_diag_data_adis1650_x
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__imu_diag_data_adis1650_x
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__imu_diag_data_adis1650_x
            cls._TYPE_SUPPORT = module.type_support_msg__msg__imu_diag_data_adis1650_x
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__imu_diag_data_adis1650_x
...
class ImuDiagDataADIS1650X(metaclass=Metaclass_ImuDiagDataADIS1650X):
    """Message class 'ImuDiagDataADIS1650X'."""
