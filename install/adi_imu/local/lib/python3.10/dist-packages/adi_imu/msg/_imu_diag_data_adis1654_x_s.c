...
bool adi_imu__msg__imu_diag_data_adis1654_x__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("adi_imu.msg._imu_diag_data_adis1654_x.ImuDiagDataADIS1654X", full_classname_dest, 58) == 0);
  }
  adi_imu__msg__ImuDiagDataADIS1654X * ros_message = _ros_message;
  {  // header
  ...
  {  // diag_automatic_reset
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_automatic_reset");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->diag_automatic_reset = (Py_True == field);
    Py_DECREF(field);
  }
  {  // diag_clock_error
  ...
  {  // diag_crc_error
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_crc_error");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->diag_crc_error = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ImuDiagDataADIS1654X */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("adi_imu.msg._imu_diag_data_adis1654_x");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImuDiagDataADIS1654X");
  ...
  {  // diag_automatic_reset
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->diag_automatic_reset ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "diag_automatic_reset", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // diag_crc_error
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->diag_crc_error ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "diag_crc_error", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
