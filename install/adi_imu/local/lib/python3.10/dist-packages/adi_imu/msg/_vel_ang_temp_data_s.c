...
bool adi_imu__msg__vel_ang_temp_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("adi_imu.msg._vel_ang_temp_data.VelAngTempData", full_classname_dest, 45) == 0);
  }
  adi_imu__msg__VelAngTempData * ros_message = _ros_message;
  {  // header
...
PyObject * adi_imu__msg__vel_ang_temp_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("adi_imu.msg._vel_ang_temp_data");
