...
namespace adi_imu
{
    WelfordCovarianceProvider::WelfordCovarianceProvider(size_t calibration_samples, double min_variance):
    ...
    bool WelfordCovarianceProvider::isReady() const
    {
        return m_calibration_complete;
    }
    ...
    CovarianceMatrix WelfordCovarianceProvider::getGyroCovariance() const
    {
